...
const players = [
    ...
    nick: "itslowedzz",
    points: 1,
    skin: "https://render.crafty.gg/3d/bust/itslowedzz",
    tiers: { Crystal: "LT5" }
  },
           {
    nick: "JaimeEpstein",
    points: 6,          
    skin: "https://render.crafty.gg/3d/bust/JaimeEpstein",
    tiers: { Mazo: "LT3" }
  },
           {
    nick: "Froziadito",
    points: 5,
    skin: "https://render.crafty.gg/3d/bust/Froziadito",
    tiers: { Crystal: "HT4", Mazo: "LT5" }
  },
           {
    nick: "D_rixzzz",
    points: 1,
    skin: "https://render.crafty.gg/3d/bust/D_rixzzz",
    tiers: { Crystal: "LT5" }
  },
           {
    nick: "Uriezen",
    points: 10,
    skin: "https://render.crafty.gg/3d/bust/Uriezen",
    tiers: { Crystal: "HT3" }
  },
           {
    nick: "len_2101",
    points: 1,
    skin: "https://render.crafty.gg/3d/bust/len_2101",
    tiers: { Sword: "LT5" }
  },
           {
    nick: "va5emphasis",
    points: 6,
    skin: "https://render.crafty.gg/3d/bust/va5emphasis",
    tiers: { Crystal: "LT3" }
  },
           {
    nick: "Ulises7826",
    points: 2,
    skin: "https://render.crafty.gg/3d/bust/Ulises7826",
    tiers: { Axe: "HT5" }
  },
           {
    nick: "KingSantiNew",
    ...
    points: 20,
    skin: "https://render.crafty.gg/3d/bust/b3atzzpurmin0te",
    tiers: { Crystal: "LT2" }
  },
           {
    nick: "fywg",
    ...
    nick: "LubbockSl",
    points: 4,
    skin: "https://render.crafty.gg/3d/bust/LubbockSl",
    tiers: { Sword: "HT4" }
  },
           {
    nick: "AndresEz",
    ...
    nick: "chiterbot",
    points: 6,
    skin: "https://render.crafty.gg/3d/bust/chiterbot",
    tiers: { NethPot: "LT3" }
  },
           {
    nick: "amongusverde",
    points: 1,
    skin: "https://render.crafty.gg/3d/bust/amongusverde",
    tiers: { Uhc: "LT5" }
  },
           {
    nick: "ItzEvelynX",
    points: 3,
    skin: "https://render.crafty.gg/3d/bust/ItzEvelynX",
    tiers: { Crystal: "LT4" }
  },
           {
    nick: "Samuu_MC",
    ...
    tiers: { Uhc: "LT3", NethPot: "LT5", Mazo: "HT5" }
  },
           {
    nick: "wqkii",
    points: 12,
    ...
    nick: "iJxliana_",
    points: 6,
    skin: "https://render.crafty.gg/3d/bust/iJxliana_",
    tiers: { NethPot: "LT3" }
  },
           {
    nick: "Pinxky",
    points: 1,
    skin: "https://render.crafty.gg/3d/bust/Pinxky",
    tiers: { Crystal: "LT5" }
  },
           {
    nick: "lemonjuice8212",
    points: 4,
    skin: "https://render.crafty.gg/3d/bust/lemonjuice8212",
    tiers: { Crystal: "HT4" }
  },
           {
    nick: "kritiga",
    points: 6,
    skin: "https://render.crafty.gg/3d/bust/kritiga",
    tiers: { Mazo: "LT3" }
  },
           {
    nick: "iiusee",
    points: 14,
    skin: "https://render.crafty.gg/3d/bust/iiusee",
    tiers: { Sword: "LT3", NethPot: "LT3", Crystal: "HT5" }
  },
           {
    nick: "Trishconcept",
    points: 6,
    skin: "https://render.crafty.gg/3d/bust/Trishconcept",
    tiers: { Crystal: "LT3" }
  },
           {
    nick: "zJeruuxP",
    points: 3,
    skin: "https://render.crafty.gg/3d/bust/zJeruuxP",
    tiers: { Crystal: "LT4" }
  },
           {
    nick: "Regidragos",
    ...
    nick: "qEvxn",
    points: 7,
    skin: "https://render.crafty.gg/3d/bust/qEvxn",
    tiers: { Uhc: "LT5", Crystal: "LT3" }
  },
           {
    nick: "Rubepro22",
    points: 5,
    ...
    tiers: { Sword: "LT3", NethPot: "LT3" }
  },
           {
    nick: "Horcrux911",
    points: 6,
    skin: "https://render.crafty.gg/3d/bust/Horcrux911",
    tiers: { NethPot: "LT4", Mazo: "HT5" }
  },
           {
    nick: "ShafyX",
    points: 10,
    skin: "https://render.crafty.gg/3d/bust/ShafyX",
    tiers: { Uhc: "HT5", NethPot: "LT3", Mazo: "HT5" }
  },
           {
    nick: "i9sl",
    points: 4,
    skin: "https://render.crafty.gg/3d/bust/i9sl",
    tiers: { Crystal: "HT4" }
  },
           {
    nick: "renox",
    points: 4,
    skin: "https://render.crafty.gg/3d/bust/renox",
    tiers: { Sword: "HT4" }
  },
           {
    nick: "Alexisfer21",
    ...
    tiers: { Uhc: "HT5", Sword: "HT5", NethPot: "LT4", Crystal: "LT5", Mazo: "LT5" }
  },
           {
    nick: "IsaakEnLaJ",
    points: 6,
    ...
    tiers: { NethPot: "LT5", Crystal: "LT3", Mazo: "LT5" }
  },
           {
    nick: "bt3zzpurmin0te",
    points: 10,
    ...
    tiers: { Sword: "LT3", NethPot: "HT4", Crystal: "LT3" }
  },
           {
    nick: "GeometryZeroMC",
    points: 2,
    ...
    tiers: { Uhc: "LT3", Sword: "HT5", NethPot: "HT5", Crystal: "HT5", Mazo: "HT5"  }
  },
           {
    nick: "teo07279",
    points: 4,
    skin: "https://render.crafty.gg/3d/bust/teo07279",
    tiers: { Sword: "HT5", NethPot: "LT5", Mazo: "LT5" }
  },
           {
    nick: "papasfritas78",
    points: 48,
    ...
    tiers: { Sword: "LT5", Crystal: "LT5", Mazo: "HT5" }
  },
           {
    nick: "itzSlowwz",
    points: 1,
    ...
    tiers: { Sword: "LT3", Crystal: "LT4", Mazo: "LT4" }
  },
           {
    nick: "rvud",
    points: 2,
    ...
    tiers: { Uhc: "LT5", Sword: "LT4", NethPot: "LT3" }
  },
     {
    nick: "CubaConDrip",
    points: 2,
  ...
  },
   {
    ...
    tiers: { Uhc: "LT4", Sword: "LT3", NethPot: "HT4", DiaPot: "LT4", Crystal: "LT5", Axe: "HT5", SMP: "LT4", Mazo: "HT4" }
  },
            {
    nick: "1vxrzide",
    points: 8,
    ...
    nick: "CatalanBoy",
    points: 20,
    skin: "https://render.crafty.gg/3d/bust/CatalanBoy",
    tiers: { Sword: "LT2" }
  },
    {
    nick: "thiagocpvp",
  ...
  },
  {
    ...
    tiers: { Uhc: "HT4", Sword: "HT4", NethPot: "HT4", Axe: " LT4", Smp: "HT4", DiaPot: "LT4", Crystal: "LT4", Mazo: "LT5" }
  },
           {
    nick: "Mariv_",
    points: 0,
